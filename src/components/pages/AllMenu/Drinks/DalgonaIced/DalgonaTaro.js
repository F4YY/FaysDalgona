...
export const DalgonaTaro = ({
  ...
  const props = menudata.find((menu) => menu.category === "Drinks" && menu.items[0].name === "Dalgona Iced" && menu.items[0].list[7].name === "Dalgona Taro");
  return (
    <>
    <ProductDetail
    ...
    >
      ...
      <ProductHero background={props.items[0].background}>
        <Img loading="lazy" src={require(`../../../../images/${props.items[0].list[7].image}`)} alt={props.items[0].list[7].name} />
        <ProductDesc>
    ...
    {rateMenu && (
      <RatingStar>
        ...
        <RatingMenuWrap>
          <RatingImg loading="lazy" src={require('../../../../images/Dalg_Taro.jpg')} alt='dalgona taro' />
