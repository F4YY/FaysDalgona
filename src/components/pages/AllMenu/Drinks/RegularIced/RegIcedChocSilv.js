...
export const RegIcedChocSilv = ({
  ...
  const props = menudata.find((menu) => menu.category === "Drinks" && menu.items[1].name === "Regular Iced" && menu.items[1].list[0].name === "Choco Silverqueen Iced");
  return (
    <>
    <ProductDetail
    ...
    {rateMenu && (
      <RatingStar>
        ...
        <RatingMenuWrap>
          <RatingImg loading="lazy" src={require('../../../../images/ReguHot_ChocSilv.jpg')} alt={props.items[1].list[0].name} />
