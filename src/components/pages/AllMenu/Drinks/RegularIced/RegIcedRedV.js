  ...
  return (
    ...
    >
      ...
      <ProductHero background={props.items[1].background}>
        <Img loading="lazy" src={require(`../../../../images/${props.items[1].list[6].image}`)} alt={props.items[1].list[6].name} />
        <ProductDesc>
    ...
    {rateMenu && (
      <RatingStar>
        ...
        <RatingMenuWrap>
          <RatingImg loading="lazy" src={require('../../../../images/ReguIced_RedV.jpg')} alt={props.items[1].list[6].name} />
