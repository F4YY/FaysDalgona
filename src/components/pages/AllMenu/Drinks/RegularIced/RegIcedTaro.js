...
export const RegIcedTaro = () => {
  ...
  const props = menudata.find((menu) => menu.category === "Drinks" && menu.items[1].name === "Regular Iced" && menu.items[1].list[7].name === "Taro Iced");
  return (
    <ProductDetail id="main-menu-container">
      ...
      <ProductHero background={props.items[1].background}>
        ...
        <ProductDesc>
          ...
          <Rating>{props.items[1].list[7].stars}★</Rating>
