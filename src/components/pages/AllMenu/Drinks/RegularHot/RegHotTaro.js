  ...
  return (
    ...
    >
      ...
      <ProductHero background={props.items[2].background}>
        <Img loading="lazy" src={require(`../../../../images/${props.items[2].list[7].image}`)} alt={props.items[2].list[7].name} />
        <ProductDesc>
    ...
    {rateMenu && (
      <RatingStar>
        ...
        <RatingMenuWrap>
          <RatingImg loading="lazy" src={require('../../../../images/ReguHot_Taro.jpg')} alt={props.items[2].list[7].name} />
