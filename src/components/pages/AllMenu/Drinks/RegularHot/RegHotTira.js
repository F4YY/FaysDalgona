...
export const RegHotTira = ({
  ...
  const props = menudata.find((menu) => menu.category === "Drinks" && menu.items[2].name === "Regular Hot" && menu.items[2].list[9].name === "Hot Tiramisu");
  return (
    <>
    <ProductDetail
    ...
    >
      ...
      <ProductHero background={props.items[2].background}>
        <Img loading="lazy" src={require(`../../../../images/${props.items[2].list[9].image}`)} alt={props.items[2].list[9].name} />
        <ProductDesc>
    ...
    {rateMenu && (
      <RatingStar>
        ...
        <RatingMenuWrap>
          <RatingImg loading="lazy" src={require('../../../../images/ReguHot_Tira.jpg')} alt={props.items[2].list[9].name} />
