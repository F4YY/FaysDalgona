...
export const RegHotRedV = ({
  ...
  const props = menudata.find((menu) => menu.category === "Drinks" && menu.items[2].name === "Regular Hot" && menu.items[2].list[6].name === "Hot Red Velvet");
  return (
    <>
    <ProductDetail
    ...
    >
      ...
      <ProductHero background={props.items[2].background}>
        <Img loading="lazy" src={require(`../../../../images/${props.items[2].list[6].image}`)} alt={props.items[2].list[6].name} />
        <ProductDesc>
    ...
    {rateMenu && (
      <RatingStar>
        ...
        <RatingMenuWrap>
          <RatingImg loading="lazy" src={require('../../../../images/ReguHot_RedV.jpg')} alt={props.items[2].list[6].name} />
