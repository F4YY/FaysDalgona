...
export const ComboTrio2 = ({
  ...
  const props = menudata.find((menu) => menu.category === "Combo" && menu.items[1].name === "Combo 123" && menu.items[1].list[5].name === "Combo Trio 2");
  return (
    <>
    <ProductDetail
    ...
    {rateMenu && (
      <RatingStar>
        ...
        <RatingMenuWrap>
          <RatingImg loading="lazy" src={require('../../../../images/ComboTrio2.jpg')} alt={props.items[1].list[5].name} />
