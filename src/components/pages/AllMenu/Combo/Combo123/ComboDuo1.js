  ...
  return (
    ...
    >
      ...
      <ProductHero background={props.items[1].background}>
        <Img loading="lazy" src={require(`../../../../images/${props.items[1].list[2].image}`)} alt={props.items[1].list[2].name} />
        <ProductDesc>
    ...
    {rateMenu && (
      <RatingStar>
        ...
        <RatingMenuWrap>
          <RatingImg loading="lazy" src={require('../../../../images/ComboDuo1.jpg')} alt={props.items[1].list[2].name} />
