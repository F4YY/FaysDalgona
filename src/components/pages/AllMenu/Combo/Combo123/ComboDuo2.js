...
export const ComboDuo2 = ({
  ...
  const props = menudata.find((menu) => menu.category === "Combo" && menu.items[1].name === "Combo 123" && menu.items[1].list[3].name === "Combo Duo 2");
  return (
    <>
    <ProductDetail
    ...
    {rateMenu && (
      <RatingStar>
        ...
        <RatingMenuWrap>
          <RatingImg loading="lazy" src={require('../../../../images/ComboDuo2.jpg')} alt="ComboDuo2" />
