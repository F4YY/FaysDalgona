...
export const ComboSolo2 = () => {
  ...
  const props = menudata.find((menu) => menu.category === "Combo" && menu.items[1].name === "Combo 123" && menu.items[1].list[1].name === "Combo Solo 2");
  return (
    <ProductDetail id="main-menu-container">
      ...
      <ProductHero background={props.items[1].background}>
        ...
        <ProductDesc>
          ...
          <Rating>{props.items[1].list[1].stars}★</Rating>
