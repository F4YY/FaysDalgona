...
export const DalCroGreenTea = ({
  ...
  const props = menudata.find((menu) => menu.category === "Combo" && menu.items[0].name === "Simple DalCro" && menu.items[0].list[2].name === "DalCro Green Tea");
  return (
    <>
    <ProductDetail
    ...
    {rateMenu && (
      <RatingStar>
        ...
        <RatingMenuWrap>
          <RatingImg loading="lazy" src={require('../../../../images/DalCro_Greentea.jpg')} alt={props.items[0].list[2].name} />
