...
export const DalCroTira = ({
  ...
  const props = menudata.find((menu) => menu.category === "Combo" && menu.items[0].name === "Simple DalCro" && menu.items[0].list[9].name === "DalCro Tiramisu");
  return (
    <>
    <ProductDetail
    ...
    {rateMenu && (
      <RatingStar>
        ...
        <RatingMenuWrap>
          <RatingImg loading="lazy" src={require('../../../../images/DalCro_Tira.jpg')} alt="dal cro tira" />
